...
class McpFirstFilmGraphService:
    ...
    def create_agent_run(
        ...
        return self.repository.create_agent_run(AgentRun(workflow_id=workflow_id, stage_name=stage_name, prompt=prompt, model_name=model_name, runtime_mode=runtime_mode, memory_user_id=memory_user_id, provenance=provenance))
