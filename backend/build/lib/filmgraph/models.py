...
class AgentRun(BaseModel):
    ...
    runtime_mode: str = "simulation"
    # A stable, privacy-preserving scope key for Agent Runtime's managed
    # Memory Bank.  Authentication will replace the browser-generated value
    # in a multi-user deployment; it is deliberately never screenplay data.
